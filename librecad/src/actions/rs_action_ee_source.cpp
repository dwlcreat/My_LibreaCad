...
struct RS_ActionEeSource::ImageData {
	RS_ImageData data;
	QImage img;
};
 ...
 * Constructor.
 */
RS_ActionEeSource::RS_ActionEeSource(RS_EntityContainer& container,
...
RS_ActionEeSource::~RS_ActionEeSource() = default;


void RS_ActionEeSource::init(int status) {
    RS_PreviewActionInterface::init(status);

    reset();

    //pImg->data.file = RS_DIALOGFACTORY->requestImageOpenDialog();
    pImg->data.file  = SOURCE_PATH;
...
void RS_ActionEeSource::trigger() {
    deletePreview();
	if (!pImg->data.file.isEmpty()) {
...
void RS_ActionEeSource::mouseMoveEvent(QMouseEvent* e) {
...
void RS_ActionEeSource::mouseReleaseEvent(QMouseEvent* e) {
...
void RS_ActionEeSource::coordinateEvent(RS_CoordinateEvent* e) {
	if (e==nullptr) {
        return;
    }
...
void RS_ActionEeSource::commandEvent(RS_CommandEvent* e) {
...
void RS_ActionEeSource::showOptions() {
...
void RS_ActionEeSource::hideOptions() {
    RS_ActionInterface::hideOptions();
	RS_DIALOGFACTORY->requestOptions(this, false);
}


void RS_ActionEeSource::updateMouseButtonHints() {
    switch (getStatus()) {
    case SetTargetPoint:
