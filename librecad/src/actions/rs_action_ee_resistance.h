...
#ifndef RS_ACTION_EE_RESISTANCE_H
#define RS_ACTION_EE_RESISTANCE_H
#include<memory>
#include<QString>
 ...
 */
class RS_ActionEeResistance : public RS_PreviewActionInterface {
	Q_OBJECT
    /**
     * Action States.
     */
...
public:
    RS_ActionEeResistance(RS_EntityContainer& container,
                        RS_GraphicView& graphicView);
    ~RS_ActionEeResistance() override;
...
protected:
	...
	Status lastStatus;
    const QString RESISTANCE_PATH=QString(":/ee/basic_component/resistance.png");
    const RS_Vector PRIVATE_U_VECTOR={0.0,0.1};
    const RS_Vector PRIVATE_V_VECTOR={0.0,0.1};
};
