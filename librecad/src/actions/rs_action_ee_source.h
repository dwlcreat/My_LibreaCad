...
#ifndef RS_ACTION_EE_SOURCE_H
#define RS_ACTION_EE_SOURCE_H
#include<memory>
#include<QString>
 ...
 */
class RS_ActionEeSource : public RS_PreviewActionInterface {
	Q_OBJECT
    /**
     * Action States.
     */
...
public:
    RS_ActionEeSource(RS_EntityContainer& container,
                        RS_GraphicView& graphicView);
    ~RS_ActionEeSource() override;
...
protected:
	...
	Status lastStatus;
    const QString SOURCE_PATH=QString(":/ee/source/source.png");
